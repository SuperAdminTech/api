...
class ApplicationTest extends WebTestCase
{
    ...
    public function testAdminGetApplication(): void
    {
    ...
    public function testAdminGetOtherApplication(): void
    {
        $this->login('admin@apps2_3.com', 'secret', 'app2');
    ...
    public function testSuperListApplications(): void
    {
        $this->login('super@example.com');
    ...
    public function testAdminListApplications(): void
    {
        $this->login('admin@example.com');
    ...
    public function testSuperDeleteApplication(): void
    {
        $this->login('super@example.com');
        $this->request('DELETE', 'sadmin/applications/5df09443-8f43-4992-bc1b-075e300af61f');
        self::assertResponseIsSuccessful();

    }

    public function testAdminDeleteApplicationShouldFail(): void
    {
        $this->login('admin@example.com');
        $this->request('DELETE', 'sadmin/applications/5df09443-8f43-4992-bc1b-075e300af61f');
